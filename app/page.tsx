...
export default function Home() {
  return (
    <main className="bg-[#1E1E1E] min-h-screen">
      ...
      <div className="flex justify-center -mt-30" data-name="Heart Decoration" data-node-id="137:11">
        <div className="relative w-[1000px] h-[1031px] opacity-16 overflow-visible">
          <img alt="" className="w-full h-full object-cover" src={imgHeartDecoration} />
        </div>
      </div>
